...
## RGBA info
- Defined at `<microgl/rgba_t.h>`, at the `microgl` namespace
...
## Color
- defined at `<microgl/color.h>`, at the `color` namespace
...
microgl also defines intensity template defined at `<microgl/intensity.h>`
```cpp
